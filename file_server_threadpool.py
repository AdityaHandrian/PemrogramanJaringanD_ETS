...
def handle_client(connection, address):
    ...
    try:
        ...
        # Use large buffer size for better performance with large files
        while True:
...
class Server:
    def __init__(self, ipaddress='0.0.0.0', port=8889, pool_size=5):
        ...
        # Set socket timeout for large file handling
    ...
    def run(self):
        ...
        self.my_socket.listen(10)  # Increased backlog for concurrent connections
